...
- **Embedded Pi Runtime**: Updated the bundled Pi coding-agent SDK from 0.80.10 to 0.81.1.

## [0.8.9] - 2026-07-19

### Changed

- **App Updates**: Update status and download progress now appear consistently in the titlebar and Settings, with clearer controls for checking, downloading, and restarting.
- **Settings**: Simplified the General, Storage, and About sections for a more compact layout.
...
- **Provider Error Visibility**: Terminal model failures now remain in the error state and show the provider's message instead of appearing as an empty completed session.
...
- **Embedded Pi Runtime**: Updated the bundled Pi coding-agent SDK from 0.80.6 to 0.80.10.

## [0.8.1] - 2026-07-10

### Changed

- **Embedded Pi Runtime**: Updated the bundled Pi coding-agent SDK from 0.75.5 to 0.80.6.
