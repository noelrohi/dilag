...
export const useHoveredElement = () => useElementSelectionStore((state) => state.hoveredElement)
...
export const useIsElementSelected = (screenId: string, selector: string) =>
  useElementSelectionStore(
    (state) =>
      state.selectedElement?.screenId === screenId && state.selectedElement?.selector === selector,
  )

// Actions
export const useSetHoveredElement = () => useElementSelectionStore((state) => state.setHovered)

export const useSetSelectedElement = () => useElementSelectionStore((state) => state.setSelected)

export const useClearElementSelection = () =>
  useElementSelectionStore((state) => state.clearSelection)

export const useClearAllElementState = () => useElementSelectionStore((state) => state.clearAll)
