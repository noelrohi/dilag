 ...
 */
export function isEventMessagePartUpdated(event: Event): event is EventMessagePartUpdated {
  return (
 ...
 */
export function isEventMessageUpdated(event: Event): event is EventMessageUpdated {
  return (
 ...
 */
export function isEventSessionStatus(event: Event): event is EventSessionStatus {
  return (
 ...
 */
export function isEventMessageRemoved(event: Event): event is Event & EventMessageRemovedCustom {
  return (
 ...
 */
export function isEventSessionUpdated(event: Event): event is Event & EventSessionUpdatedCustom {
  return (
 ...
 */
export function isEventServerHeartbeat(event: Event): event is Event & EventServerHeartbeat {
 ...
 */
export function isEventFileWatcherUpdated(event: Event): event is Event & EventFileWatcherUpdated {
  return (
 ...
 */
export function isEventProjectUpdated(event: Event): event is Event & EventProjectUpdated {
  return (
 ...
 */
export function isEventVcsBranchUpdated(event: Event): event is Event & EventVcsBranchUpdated {
  return (
 ...
 */
export function isEventPermissionAsked(event: Event): event is Event & EventPermissionAsked {
  return (
 ...
 */
export function isEventPermissionReplied(event: Event): event is Event & EventPermissionReplied {
  return (
 ...
 */
export function isEventQuestionAsked(event: Event): event is Event & EventQuestionAsked {
  return (
 ...
 */
export function isEventQuestionReplied(event: Event): event is Event & EventQuestionReplied {
  return (
 ...
 */
export function isEventQuestionRejected(event: Event): event is Event & EventQuestionRejected {
  return (
...
export function extractSessionId(event: Event): string | null {
  ...
  if ("properties" in event && event.properties !== null && typeof event.properties === "object") {
    ...
    // Nested in info
    if ("info" in props && props.info !== null && typeof props.info === "object") {
    ...
    // Nested in part
    if ("part" in props && props.part !== null && typeof props.part === "object") {
