        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="mb-4">
                Dilag collects limited data needed to operate and improve the product:
              </p>
            ...
            <section>
              ...
              <p>
                We apply reasonable technical and organizational safeguards. You can request
                deletion of personal data by contacting us.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Dilag integrates with third-party providers where required to run the service:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>AI Providers:</strong> Design generation
                </li>
                <li>
                  <strong>GitHub:</strong> Code hosting and issue tracking
                </li>
              </ul>
            </section>
