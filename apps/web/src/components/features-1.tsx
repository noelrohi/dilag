      ...
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Generate beautiful UI designs from natural language, powered by AI.
          </p>
        </div>
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
          <Card className="group shadow-zinc-950/5">
            ...
            <CardContent>
              <p className="text-sm">
                Generate complete UI designs in seconds. Describe what you want and watch it come to
                life in real-time.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-zinc-950/5">
            ...
            <CardContent>
              <p className="mt-3 text-sm">
                Get production-ready HTML and CSS code that you can copy directly into your
                projects.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group shadow-zinc-950/5">
            ...
            <CardContent>
              <p className="mt-3 text-sm">
                Choose from Claude, GPT-5.2, Gemini, and more. Use the AI model that works best for
                you.
              </p>
            </CardContent>
          </Card>
